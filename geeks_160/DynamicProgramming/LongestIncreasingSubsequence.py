...
class Solution:
    def lengthOfLIS(self, arr):
        ...
        for num in arr:
            # Find the index of the smallest number in tails which is greater than or equal to num
...
sol = Solution()
arr1 = [5, 8, 3, 7, 9, 1]
print(sol.lengthOfLIS(arr1))  # Output: 3

arr2 = [0, 8, 4, 12, 2, 10, 6, 14, 1, 9, 5, 13, 3, 11, 7, 15]
print(sol.lengthOfLIS(arr2))  # Output: 6

arr3 = [3, 10, 2, 1, 20]
print(sol.lengthOfLIS(arr3))  # Output: 3
